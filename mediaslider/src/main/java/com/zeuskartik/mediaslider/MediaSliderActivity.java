...
public class MediaSliderActivity extends AppCompatActivity {
    ...
    private ArrayList<File> urlList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "CameraTech" + File.separator + "images/");

        ArrayList<File> files = new ArrayList<>();
        if (dir.isDirectory()) {
            for (String str : Objects.requireNonNull(dir.list()))
                files.add(new File(dir, str));
        }
...
//                    }
    ...
    public void loadMediaSliderView(ArrayList<File> mediaUrlList, String mediaType, boolean isTitleVisible, boolean isMediaCountVisible, boolean isNavigationVisible, String title, String titleBackgroundColor, String titleTextColor, int startPosition) {
    ...
    private class ScreenSlidePagerAdapter extends PagerAdapter {
        ...
        private ScreenSlidePagerAdapter(Context context, ArrayList<File> urlList, String token) {
